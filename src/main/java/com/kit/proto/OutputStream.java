...
public class OutputStream {
    ...
    public void writeProtoLongs(long[] values) throws IOException {
        if (values.length > Const.MAX_PROTO_REPEATED) {
            throw new IllegalArgumentException("Values can't be more than " + Const.MAX_PROTO_REPEATED);
        }
